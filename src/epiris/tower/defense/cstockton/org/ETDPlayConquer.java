...
public class ETDPlayConquer extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);

		setContentView(R.layout.play_conquer);
		...
		final Spinner mapSpinner = (Spinner) findViewById(R.id.play_conquer_level_spinner);
		mapSpinner.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, maps));

		final Spinner difficultySpinner = (Spinner) findViewById(R.id.play_conquer_difficulty_spinner);
        ...
        ((Button) findViewById(R.id.button_back)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View v) {
                    ETDPlayConquer.this.finish();
                }
            }
        );

        ((Button) findViewById(R.id.play_conquer_play_now_button)).setOnClickListener(new View.OnClickListener() {

                @Override
                public void onClick(final View v) {
                    final Intent intent = new Intent(ETDPlayConquer.this.getApplicationContext(), ETDGameActivity.class);
                    final GameOptions gameOptions = new GameOptions();

                    // set our game options
                    gameOptions.setMode(GameTypes.CONQUER);
